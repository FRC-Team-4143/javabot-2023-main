...
public final class Constants {
    ...
    public static final class SwerveConstants extends Mk4iSwerveConstants {}

    public static class Mk4iSwerveConstants {
        // See https://github.com/Team364/BaseFalconSwerve for getting these values.

        public static final int PIGEON_PORT = 0;

        public static final double trackWidth = Units.inchesToMeters(14.375); 
        public static final double wheelBase = Units.inchesToMeters(34.5);
...
//             public static final int analogEncoderID = 
