...
public final class Constants {
    ...
    public static class Alpha4143SwerveConstants {
        ...
        public static final int driveContinuousCurrentLimit = 80; //40;
        public static final int drivePeakCurrentLimit = 80; //60;
        ...
        public static final double driveKS =
                (0.2); // Used to be 0.667
        public static final double driveKV = (1.65); // Used to be 2.44
        public static final double driveKA = (2); // Used to be 0.27
        ...
        public static final class Mod2 {    
            public static final String canivoreName = "CANivore2";
